...
export const TimelineScrubber: FC = () => {
    ...
    return (
        <div className="absolute bottom-[36px] left-[288px] right-[400px] bg-[#05080f]/90 backdrop-blur border-t border-x border-[#1e293b] rounded-t-xl px-6 py-4 flex flex-col gap-3 z-40 transition-all duration-300 pointer-events-auto">
            <div className="flex items-center justify-between">
                ...
                {selectedCommit && (
                    <div className="flex items-center gap-4 text-xs text-white/60">
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-1 bg-[#0f172a] rounded border border-[#1e293b]">
                            <User size={12} className="text-slate-500" />
                            <span className="text-slate-300 font-medium tracking-wide">{selectedCommit.author}</span>
                        </div>
                    </div>
                )}
            </div>
