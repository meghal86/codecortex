...
export const FileTreePanel = ({ onFocusNode }: FileTreePanelProps) => {
  ...
  if (isCollapsed) {
    return (
      <div className="h-full w-12 bg-[#000] border-r border-[#1c1c1c] flex flex-col items-center py-3 gap-2 flex-shrink-0">
        <button
  ...
  return (
    <div className="h-full w-64 bg-[#000] border-r border-[#1c1c1c] flex flex-col transition-all overflow-hidden flex-shrink-0">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-[#1c1c1c] bg-[#000]">
