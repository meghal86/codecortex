...
export const RightPanel = () => {
  ...
  return (
    <aside className="h-full w-[400px] flex flex-col bg-[#000] text-[#ededed] relative z-30 transition-all flex-shrink-0">
      {/* Header with Tabs */}
      <div className="flex items-center justify-between px-4 py-2 bg-[#080808] border-b border-[#1c1c1c]">
      ...
      {activeTab === 'chat' && (
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Input */}
          <div className="p-3 bg-[#0a0f18] border-t border-[#1e293b]">
            <div className="flex items-end gap-2 px-3 py-2 bg-[#0f172a] border border-[#1e293b] rounded-md transition-all focus-within:border-cyan-500/50">
              <textarea
                ref={textareaRef}
                value={chatInput}
